...
The data points lie primarily along the line in the qqplot, so we can assume 
...
The tails of the sample quantile data pull away from the line, but, for the most 
part, the points lie on the line quite well. Therefore, it is safe to assume normality.
